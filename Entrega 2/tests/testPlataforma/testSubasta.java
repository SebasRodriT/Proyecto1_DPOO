...
public class testSubasta {
	...
	public void testPiezaASubastar() throws Exception {
		...
		operador.registrarOfertasSubasta(comprador3, lNE, 1000000000);
		operador.registrarOfertasSubasta(comprador4, lNE, 1100000000);
		operador.registrarOfertasSubasta(comprador5, lNE, 2000000000);
		assertEquals(comprador5.getNombre(), operador.identificarPostorGanador(lNE).getNombre());
